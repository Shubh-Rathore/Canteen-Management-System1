...
class order
{
    public:
        ...
        void orderpage()
        {
            ...
            gotoxy(40,1);cout<<"  LNCT CANTEEN";
            gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
            gotoxy(5,4);cout<<"ORDER"<<endl<<endl;
...
class employee
{
    public:
        ...
        void emppage()
        {
            ...
            gotoxy(40,1);cout<<"  LNCT CANTEEN";
            gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
            gotoxy(10,4);cout<<"WELCOME OWNER"<<endl<<endl;
...
class login
{
  public:
      ...
      {
          system("CLS");
          gotoxy(40,1);cout<<" LAKSHMI NARAYAN GROUP OF COLLEGES";
          gotoxy(40,3);cout<<"***** WELCOME TO LNCT CANTEEN *****";
          gotoxy(40,4);cout<<" "<<endl<<endl;
          gotoxy(5,5);cout<<"HOME PAGE "<<endl<<endl;
          cout<<"     1. LOGIN"<<endl;
      ...
      void loginpage()
      {
          ...
          gotoxy(40,1);cout<<"  LNCT CANTEEN";
          gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
          gotoxy(5,5);cout<<"LOGIN MENU"<<endl<<endl;
